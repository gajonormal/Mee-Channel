...
export default function DiscordCard() {
  return (
    <Card
      href="https://discord.com/users/gajonormal"
      additionalClasses="hover:scale-100 bg-[#5865F2]"
    >
      <div className="px-[22px] py-4 flex flex-col justify-end items-start text-white h-full">
        ...
        <div className="absolute -bottom-6 -right-4 w-20 h-20 rounded-full bg-white/10 group-hover:scale-110 transition-transform duration-700" />
      </div>
    </Card>
  );
}
